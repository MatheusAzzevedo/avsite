...
Resumo: Upload de documento (PDF, DOCX, XLS, XLSX) no cadastro de excursões pedagógicas. O documento fica disponível para download na página da excursão. Executar `npx prisma db push` ou migration SQL.

### Versão anterior (2026-03-04) - feat: primeira seção Sobre nós com fundo branco
